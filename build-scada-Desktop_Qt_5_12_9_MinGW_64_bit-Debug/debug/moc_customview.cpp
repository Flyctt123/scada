...
QT_MOC_LITERAL(1, 11, 20), // "backgroundNeedsPaint"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 9), // "QPainter*"
QT_MOC_LITERAL(4, 43, 7), // "painter"
QT_MOC_LITERAL(5, 51, 4) // "rect"

    },
    "CustomView\0backgroundNeedsPaint\0\0"
...
void CustomView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->backgroundNeedsPaint((*reinterpret_cast< QPainter*(*)>(_a[1])),(*reinterpret_cast< const QRectF(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CustomView::*)(QPainter * , const QRectF & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomView::backgroundNeedsPaint)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomView::backgroundNeedsPaint(QPainter * _t1, const QRectF & _t2)
{
